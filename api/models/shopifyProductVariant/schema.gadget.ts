...
// This file describes the schema for the "shopifyProductVariant" model, go to https://customer-favorites-app.gadget.app/edit to view/edit your model in Gadget
